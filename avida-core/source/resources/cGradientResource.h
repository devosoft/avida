...
namespace Avida {
  namespace Resource {
    ...
    class cGradientResourcePopulationInterface;
    ...
    protected:
      ...
      std::unique_ptr<cGradientResourceAcct> m_acct;
    ...
    public:
      explicit cGradientResource(ResID res_id, const cString& name, Avida::Feedback& fb)
    ...
    protected:
      ...
      cGradientResourcePopulationInterface* m_pop;
      
      
      int m_size_x;  //Grid size from the perspective of the resource
      int m_size_y;
    ...
    public:
      cGradientResourceAcct(cGradientResource& res, cPopulation* pop);
      ...
      inline void SetIsPath(bool path);
    ...
    inline void cGradientResourceAcct::SetIsPath(bool path)
    {
      m_path = path;
    }
