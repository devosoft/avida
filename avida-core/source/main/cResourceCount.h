...
public:
  ...
  void Setup(cWorld* world, const int& id, const cString& name, const double& initial, const double& inflow, const double& decay,                      
     ...
     const double& in_damage, const double& in_death_odds, const double& in_init_plat, const double& in_threshold, const int& in_refuge, const bool& isgradient
	   ); 
  ...
  void SetGradientCount(cAvidaContext& ctx, cWorld* world, const int& res_id, const int& peakx, const int& peaky,
    ...
    const double& death_odds, const double& plat_val, const double& threshold, const int& refuge);
