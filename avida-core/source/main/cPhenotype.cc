...
, cur_rbins_total(m_world->GetEnvironment().GetResourceRegistry().GetSize())
, cur_rbins_avail(m_world->GetEnvironment().GetResourceRegistry().GetSize())
...
, sensed_resources(m_world->GetEnvironment().GetResourceRegistry().GetSize())
...
, last_rbins_total(m_world->GetEnvironment().GetResourceRegistry().GetSize())
, last_rbins_avail(m_world->GetEnvironment().GetResourceRegistry().GetSize())
...
{ 
  ...
  double num_resources = m_world->GetEnvironment().GetResourceRegistry().GetSize();
