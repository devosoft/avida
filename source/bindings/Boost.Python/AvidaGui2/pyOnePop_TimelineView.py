...
# Form implementation generated from reading ui file '/Users/kaben/Projects/Software/Avida/branch.kaben/avida--current--2.0--base-0/source/bindings/Boost.Python/AvidaGui2/pyOnePop_TimelineView.ui'
#
...
class pyOnePop_TimelineView(QWidget):
  def __init__(self,parent = None,name = None,fl = 0):
    ...
    if not name:
      self.setName("pyOnePop_TimelineView")


    pyOnePop_TimelineViewLayout = QVBoxLayout(self,0,6,"pyOnePop_TimelineViewLayout")
    pyOnePop_TimelineViewLayout.setResizeMode(QLayout.Minimum)
    ...
    pyOnePop_TimelineViewLayout.addLayout(layout214)
    ...
    pyOnePop_TimelineViewLayout.addWidget(self.pyTimelineCtrl1)
  ...
  def languageChange(self):
    self.setCaption(self.__tr("pyOnePop_TimelineView"))
    self.textLabel9.setText(self.__tr("Timeline"))
    self.toolButton31_2.setText(QString.null)


  def __tr(self,s,c = None):
    return qApp.translate("pyOnePop_TimelineView",s,c)
