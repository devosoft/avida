...
tInstLib<cHardwareCPU::tMethod>* cHardwareCPU::initInstLib(void)
{
  ...
  static const tInstLibEntry<tMethod> s_f_array[] = {
    ...
    tInstLibEntry<tMethod>("increment-set-display-a", &cHardwareCPU::Inst_SetMatingDisplayA),
    tInstLibEntry<tMethod>("increment-set-display-b", &cHardwareCPU::Inst_SetMatingDisplayB),
