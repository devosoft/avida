...
private:
  ...
  bool DoSenseResourceX(int reg_to_set, int cell_id, int resid, cAvidaContext* ctx); //JW
  ...
  void DoResourceDonatePercent(cAvidaContext* ctx, const int to_cell, const int resource_id, const double frac_resource_given); //JW
  void DoResourceDonateAmount(cAvidaContext* ctx, const int to_cell, const int resource_id, const double amount); //JW
