...
Avida::cGenome::cGenome(const cString& seq_str)
{
  cString str = seq_str;
...
void Avida::cGenome::Load(const tDictionary<cString>& props, cHardwareManager& hwm)
{
...
void Avida::cGenome::Save(cDataFile& df)
{
...
cString Avida::cGenome::AsString() const
{
...
void Avida::cGenome::SaveAsDetailFile(cDataFile& df, cHardwareManager& hwm)
{
