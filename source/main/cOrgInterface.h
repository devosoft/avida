...
public:
  ...
  virtual const tArray<double>& GetResources(cAvidaContext* ctx) = 0; //JW
  virtual const tArray<double>& GetFacedCellResources(cAvidaContext* ctx) = 0; //JW
  virtual const tArray<double>& GetDemeResources(int deme_id, cAvidaContext* ctx) = 0; //JW
  ...
  virtual void Die(cAvidaContext* ctx) = 0; //JW
  virtual void KillCellID(int target, cAvidaContext* ctx) = 0; //JW
  virtual void Kaboom(int distance, cAvidaContext* ctx) = 0; //JW
  virtual void SpawnDeme(cAvidaContext* ctx) = 0; //JW
