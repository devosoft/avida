...
#ifndef cDynamicResElement_h
#define cDynamicResElement_h

#include "avida/core/Types.h"


class cDynamicResElement
{
private:
...
public:
  cDynamicResElement();
  cDynamicResElement(double initamount);
  ...
  friend void FlowMatter(cDynamicResElement&, cDynamicResElement&, double, double, double, double,
                         int, int, double);
