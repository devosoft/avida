...
cDynamicResElement::cDynamicResElement(double initamount)
{
  amount = initamount;
  delta = 0.0;
  initial = initamount;
...
cDynamicResElement::cDynamicResElement()
{
  amount = 0.0;
  delta = 0.0;
  initial = 0.0;
...
void cDynamicResElement::SetPtr(int innum, int inelempt, int inxdist, int inydist, double indist)
{
